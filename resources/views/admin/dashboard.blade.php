<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 dark:bg-[#0A0A0A]">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- Admin Analytics Card Grid (Matching Member Dashboard styling precisely!) -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
                <!-- Stat Card 1 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Total Users</p>
                ...
                <!-- Stat Card 2 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Total Lots</p>
                    <div class="flex items-baseline mt-2">
                        <span class="text-2xl font-extrabold text-gray-900 dark:text-zinc-100">
                ...
                <!-- Stat Card 3 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Active Lots</p>
                    <div class="flex items-baseline mt-2">
                ...
                <!-- Stat Card 4 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Ended Lots</p>
                    <div class="flex items-baseline mt-2">
                ...
                <!-- Stat Card 5 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Total Bids</p>
                    <div class="flex items-baseline mt-2">
                ...
                <!-- Stat Card 6 -->
                <div class="bg-white dark:bg-[#121212] border border-gray-150 dark:border-zinc-900 p-6 rounded-lg shadow-sm">
                    <p class="text-xxs font-bold text-gray-400 dark:text-zinc-550 uppercase tracking-wider">Net Revenue</p>
                    <div class="flex items-baseline mt-2">
                        ...
                        @forelse($recentAuctions as $auction)
                            <div class="p-4 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-zinc-900/30 transition-colors">
                                <div class="min-w-0 pr-4">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-zinc-550 mt-0.5">
                                        Creator: <span class="font-medium text-gray-700 dark:text-zinc-400">{{ $auction->user->name }}</span> · {{ $auction->bids_count }} bids
                                    </p>
                                </div>
                                <div class="text-right shrink-0">
                                    <span class="text-xs text-gray-400 dark:text-zinc-550">{{ $auction->created_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        @empty
                        ...
                        @forelse($recentBids as $bid)
                            <div class="p-4 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-zinc-900/30 transition-colors">
                                <div class="min-w-0 pr-4">
                                    ...
                                    <p class="text-xs text-gray-400 dark:text-zinc-550 mt-0.5 truncate">{{ $bid->auction->title }}</p>
                                </div>
                                <div class="text-right shrink-0">
            ...
            <!-- Quick Action Section (Matching Member Dashboard style precisely!) -->
