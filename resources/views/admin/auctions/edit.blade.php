    ...
    <div class="py-12 bg-gray-50 dark:bg-[#0A0A0A]">
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-base font-bold text-gray-900 dark:text-zinc-100">Edit Lot Information</h3>
                    <p class="text-xs text-gray-400 dark:text-zinc-550">Update parameters, active status, or listing image for this lot.</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="status" name="status"
                                        class="mt-1 block w-full rounded-md border-gray-250 dark:border-zinc-800 bg-white dark:bg-[#181818] text-gray-900 dark:text-zinc-100 shadow-sm focus:border-amber-500 focus:ring-amber-500">
                            ...
                            <div>
                                ...
                                @if($auction->image)
                                    <p class="mt-2 text-xxs text-gray-400 dark:text-zinc-500">Current display file: {{ basename($auction->image) }}</p>
                                @endif
                            </div>
                        </div>
